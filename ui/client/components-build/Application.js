						...
						React.DOM.form({className: "navbar-form navbar-right form-inline"}, 
							React.DOM.div({className: "form-group"}, 
								React.DOM.div({className: "btn-group"}, 
									React.DOM.button({type: "button", className: "btn btn-default dropdown-toggle", 'data-toggle': "dropdown"}, 
										"Host: localhost ", React.DOM.span({className: "caret"})
									), 
									React.DOM.ul({className: "dropdown-menu app-dropdown-with-buttons", role: "menu"}, 
										React.DOM.li(null, 
											React.DOM.a({href: "#"}, "localhost longer name blah"), 
										...
										React.DOM.li(null, 
											React.DOM.div({className: "form-group"}, 
												React.DOM.div({className: "input-group input-group-sm"}, 
													React.DOM.input({type: "text", className: "form-control", placeholder: "New host"}), 
													React.DOM.span({className: "input-group-btn"}, 
														React.DOM.button({className: "btn btn-default", type: "button"}, "OK")
													)
												)
											)
										)
							...
							React.DOM.div({className: "form-group"}, 
								React.DOM.div({className: "btn-group"}, 
									...
									React.DOM.ul({className: "dropdown-menu app-dropdown-with-buttons", role: "menu"}, 
										React.DOM.li(null, 
											React.DOM.a({href: "#"}, "2222"), 
											React.DOM.button({type: "button", className: "btn btn-link btn-sm app-dropdown-btn"}, 
												React.DOM.span({className: "glyphicon glyphicon-remove"})
											)
										), 
										React.DOM.li(null, 
											React.DOM.a({href: "#"}, "8080"), 
											React.DOM.button({type: "button", className: "btn btn-link btn-sm app-dropdown-btn"}, 
												React.DOM.span({className: "glyphicon glyphicon-remove"})
											)
										), 
										...
										React.DOM.li(null, 
											React.DOM.div({className: "form-group"}, 
												React.DOM.div({className: "input-group input-group-sm"}, 
													React.DOM.input({type: "text", className: "form-control", placeholder: "New port"}), 
													React.DOM.span({className: "input-group-btn"}, 
														React.DOM.button({className: "btn btn-default", type: "button"}, "OK")
													)
												)
							...
							' ', 
							React.DOM.button({type: "submit", className: "btn btn-primary"}, "Listen")
						)
					)
				), 
								...
								React.DOM.tr(null, 
									React.DOM.td(null, 
										React.DOM.div({className: "input-group"}, 
											React.DOM.input({type: "text", className: "form-control", value: "5m"}), 
